...
- Provide a single search and management surface over OER drawn from multiple repositories, catalogues, and APIs.
...
- Encourage critical reading of AI-generated text such as quality scores and summaries by explaining how these are produced and by linking back to the underlying records.
- Design features so local policies on AI, academic integrity, and resource selection can be applied consistently.

### 5. Offer policy-aligned, optional AI profiles

- Allow institutions to run OER_Phoenix in a minimal mode with no AI services, or in a fuller mode that enables semantic search and enrichment where policies permit.
- Support different technical and policy contexts by making enrichment and search backends pluggable.
- Minimise unnecessary data exposure to third-party AI services by keeping enrichment pipelines configurable and documented.

### 6. Fit into real library and teaching workflows

- Support collection building, reading-list support, and local review or governance processes.
...
- Enable institutions to align OER_Phoenix with their own information-literacy and AI-usage guidance.
- Support teaching and workshop use-cases that compare original resources with enriched or AI-assisted metadata.
...
- Use open formats and commonly available open-source tooling so deployments are inspectable, repeatable, and maintainable by typical institutional teams.
